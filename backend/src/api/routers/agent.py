...
_TEAMS = [
    TeamResponse(
        ...
        description="Dashboards, Data Engineering, Cloud Architecture. Especialistas en pipelines de datos, BI avanzado y soluciones cloud-native.",
        capabilities=["Dashboards", "Data Engineering", "Cloud", "BI", "ETL/ELT"],
        icon="brain",
        is_best_match=False,
    ),
    TeamResponse(
        id="ai-lab",
        name="AI Lab",
        description="AI Engineers, AI Products, Agentes Autónomos. Laboratorio de IA generativa, LLMs, RAG y soluciones conversacionales.",
        capabilities=["AI Engineering", "LLM/RAG", "AI Agents", "GenAI Products", "NLP"],
        icon="sparkles",
        is_best_match=False,
    ),
    TeamResponse(
        ...
        description="Marketing Automation, CRM, Growth Hacking. Estrategias de adquisición, personalización y optimización de conversión.",
        capabilities=["Growth", "Marketing Digital", "CRM", "Automation", "Analytics"],
        icon="megaphone",
        is_best_match=False,
    ),
]
...
_BEST_MATCH_RULES: dict[str, str] = {
    ...
    "personalizacion": "growth-marketing",
    "crm": "growth-crm",
