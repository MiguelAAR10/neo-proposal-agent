    ...
    >
        ...
        <div className="flex items-center gap-3">
          {caseData.url_slide ? (
            <a 
              ...
              className="text-xs font-semibold text-[var(--accent)] hover:text-white focus-visible:text-white flex items-center gap-1"
            >
              Ver Presentación
      ...
      <div className="mt-3">
        <button
          ...
          className={cn(
            "w-full rounded-md border px-3 py-2 text-xs font-semibold transition-colors focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0b1022]",
            isSelected
