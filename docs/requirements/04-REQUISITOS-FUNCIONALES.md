...
**Criterios de aceptación:**
- [ ] Generar embedding del problema con Gemini (`gemini-embedding-001`)
...
- [ ] Mostrar fuente: "Datos de febrero 2026" o "Cacheado"
...
- [ ] Mensaje claro: "Base de conocimiento vacía. Contactar admin@neo.com"
